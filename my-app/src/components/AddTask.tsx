            ...
            <div className="mb-12">
                <form onSubmit={onSubmit}>
                    <div>
                        ...
                        <button type='submit' className="mt-3 flex w-full justify-center rounded-md rounded-mg bg-[#C8A1B1] px-3 py-1.5 text-sm/6 font-semibold hover:bg-[#6D6943] focus-visible:outline-2 focus-visible:outline-offset-2 cursor-pointer">
                            add!
                        </button>
                    </div>
                </form>
