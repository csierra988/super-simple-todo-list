            ...
            <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
                <form onSubmit={onSubmit}>
                    <div>
                        ...
                        <div className="mt-2">
                            <input value={name} onChange={(e) => setName(e.target.value)} name="name" type="text" className="block w-full rounded-md bg-isabelline px-3 py-1.5 text-base outline-1 -outline-offset-1 focus:outline-pinklav"/>
                        </div>
                    ...
                    <div className="mt-10">
                        <button type="submit" className="flex w-full justify-center rounded-mg rounded-md  bg-[#C8A1B1] px-3 py-1.5 text-sm/6 font-semibold hover:bg-[#6D6943] hover:text-isabelline focus-visible:outline-2 focus-visible:outline-offset-2 cursor-pointer">
                            Sign up!
                        </button>
                    </div>
